...
//         int startTotal = st_hr * 60 + st_min;
//         System.out.println(startTotal+" startTotal");
//         int endTotal = end_hr * 60 + end_min;
//         System.out.println(endTotal+" endTotal");

//         // Handle wrap-around midnight
//         if (endTotal < startTotal)
//           endTotal += 1440;
//         System.out.println(endTotal+" endTotal after wrap-around");

//         // Round start time UP to next 15-minute boundary
//         int first = ((startTotal + 14) / 15) * 15;
//         System.out.println(first+" first");
//         // Round end time DOWN to previous 15-minute boundary
//         int last = (endTotal / 15) * 15;
